...
Examples of using glpsol on the example input 
  $ solve () { glpsol --math $1 -y solution > /dev/null && cat solution; }
The 1st equation of the example input
  $ solve example_1_min.gmpl
  x1=1 x2=5 x3=0 x4=1 x5=3 x6=0 total=10
The 2nd equation of the example input, but in a maximizing form
  $ solve example_1_max.gmpl
  x1=5 x2=2 x3=4 x4=0 x5=0 x6=3 total=14
The 3rd and last equation of the example input
  $ solve example_3_min.gmpl
  a=5 b=0 c=5 d=1 total=11
